...
if __name__ == '__main__':
	...
	tokenizer = PreTrainedTokenizerFast.from_pretrained('digit82/kobart-summarization', model_max_length=max_pos)
	kobart_longformer = BartForConditionalGeneration.from_pretrained('digit82/kobart-summarization')
	config  = LongformerBartConfig.from_pretrained('digit82/kobart-summarization')
